...
Welcome to `lrud`, "a spatial navigation library for devices with input via directional controls". Thanks for your interest in contributing.

Here's how to get involved...

## Reporting Issues
Before opening a new issue, first check that there is not already an [open issue or Pull Request](https://github.com/bamlab/lrud/issues) that addresses it.
...
1. Pick an appropriate template for the type of issue [from here](https://github.com/bamlab/lrud/issues)
